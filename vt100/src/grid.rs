...
impl Grid {
    ...
    /// Drop every row from the saved scrollback buffer without
    /// touching the live drawing rows or cursor state. Implements the
    /// xterm "Erase Saved Lines" sequence (`ESC [ 3 J`).
